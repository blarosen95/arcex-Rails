module MailerHelper
    ...
    def shadows
      '
        ...
        .btn-shadow-md a { box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); }
        .btn-shadow-lg a { box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05); }
        .btn-shadow-xl a { box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04); }
        .btn-shadow-2xl a { box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25); }
        .btn-shadow-inner a { box-shadow: inset 0 2px 4px 0 rgba(0, 0, 0, 0.06); }
